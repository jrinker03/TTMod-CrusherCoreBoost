...
namespace TTMod_CrusherCoreBoost
{
    // TODO Review this file and update to your own requirements.

    [BepInPlugin(MyGUID, PluginName, VersionString)]
    public class TTMod_CrusherCoreBoostPlugin : BaseUnityPlugin
    {
        ...
        // e.g.
        // 1.0.0
        private const string MyGUID = "com.james.TTMod_CrusherCoreBoost";
        private const string PluginName = "TTMod_CrusherCoreBoost";
        ...
        // e.g.
        // float myFloat = TTMod_CrusherCoreBoostPlugin.FloatExample.Value;
        ...
        private void Awake()
        {
            ...
            // .e.g.
            // TTMod_CrusherCoreBoostPlugin.Log.LogDebug("Debug Message to BepInEx log file");
            Log = Logger;
        }
        ...
        private void Update()
        {
            if (TTMod_CrusherCoreBoostPlugin.KeyboardShortcutExample.Value.IsDown())
            {
