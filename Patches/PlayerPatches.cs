...
namespace TTMod_CrusherCoreBoost.Patches
{
    ...
    internal class PlayerPatches
    {
        ...
        {
            TTMod_CrusherCoreBoostPlugin.Log.LogInfo("In Player Awake method Prefix.");
            return true;
        }
        ...
        {
            TTMod_CrusherCoreBoostPlugin.Log.LogInfo("In Player Awake method Postfix.");
        }
    }
}